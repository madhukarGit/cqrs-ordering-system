...
public class OrderCreateCommandHandler {
    ...
    public OrderCreateCommandHandler(OrderDomainService orderDomainService, OrderRepository orderRepository, CustomerRepository customerRepository,
                                     RestaurantRepository restaurantRepository, OrderDataMapper orderDateMapper) {
        this.orderDomainService = orderDomainService;
        this.orderRepository = orderRepository;
        this.customerRepository = customerRepository;
        this.restaurantRepository = restaurantRepository;
        this.orderDataMapper = orderDateMapper;
    }
    ...
    public CreateOrderResponse createOrder(CreateOrderCommand createOrderCommand){
        ...
        CreateOrderResponse response =
                orderDataMapper.orderToCreateOrderResponse(savedOrder);
